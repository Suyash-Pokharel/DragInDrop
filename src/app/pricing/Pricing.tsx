    ...
    <div className="min-h-screen bg-background text-text-main pt-10 pb-5 px-3 transition-colors duration-300 font-sans">
      <div className="max-w-[90%] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 w-full gap-y-12 max-w-6xl mx-auto mb-18 justify-items-center items-start">
          {/* 1. STARTER PLAN */}
          <div className="w-[321px] bg-surface text-text-main border border-surface rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:border-2 hover:border-primary transform hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden flex flex-col h-full items-center">
            <div className="text-center mb-6">
          ...
          {/* 2. PRO PLAN (Highlighted - First on Mobile, Middle on Desktop) */}
          <div className="w-[321px] order-first lg:-order-1 xl:order-0 relative bg-surface text-text-main border-3 border-primary rounded-2xl p-8 shadow-glow transform md:-translate-y-4 hover:-translate-y-6 transition-transform duration-300 overflow-hidden flex flex-col h-full items-center z-10">
