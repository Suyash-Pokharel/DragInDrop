...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    //  Query SocialAccount where userId matches and platform="TikTok"
    ...
    try {
      ...
      console.log("[DELETE /api/oauth/tiktok/disconnect] Notification created successfully:", {
        userId: user.id,
        platform,
        timestamp: new Date().toISOString(),
      });
      ...
      console.error("[DELETE /api/oauth/tiktok/disconnect] Failed to create notification:", {
        userId: user.id,
        platform,
        timestamp: new Date().toISOString(),
