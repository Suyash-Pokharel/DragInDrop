...
export default function PreferencesPage() {
  ...
  const [originalPreferences, setOriginalPreferences] = useState<PreferencesState | null>(null);
  ...
  const autoSaveDetectedTimezone = useCallback(async (detectedTimezone: string) => {
    try {
      ...
      const autoSavePreferences = {
        dateFormat: originalPreferences?.dateFormat || "DD/MM/YYYY",
        timeFormat: originalPreferences?.timeFormat || "12h", 
        firstDayOfWeek: originalPreferences?.firstDayOfWeek || "sunday",
