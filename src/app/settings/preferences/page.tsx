...
import { getTimezones, getUserTimezone, TimezoneOption } from "@/utils/timezones";

const timezonesList: TimezoneOption[] = getTimezones();
...
export default function PreferencesPage() {
  ...
  useEffect(() => {
    ...
    } else if (timezonesList.length > 0) {
      setSelectedTimezone(timezonesList[0].value);
    }
  }, []);
