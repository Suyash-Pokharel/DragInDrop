...
/**
 * Client component for Referral page.
 * Displays referral link and allows users to copy it to clipboard.
 * Handles interactive features: copy to clipboard, apply referral code.
 * Currently displays hardcoded referral link.
 */
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 mt-2">
            ...
            <div className="flex items-center gap-1.5 mt-1 text-xs text-text-secondary/70">
              ...
              <span>
                Only one code can be applied per account. So if you have already applied a code, you
                cannot apply a second one.
              </span>
            </div>
          </div>
        </section>
