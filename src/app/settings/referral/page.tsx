  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out flex flex-col gap-6 w-full max-w-3xl">
      <div className="mb-2">
        ...
        <p className="text-text-secondary text-sm md:text-base">Invite friends and earn rewards based on their subscription plan.</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 md:p-8 flex flex-col gap-8 shadow-sm">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="bg-background border border-border p-5 rounded-xl mt-2">
            <p className="text-sm text-text-main mb-3">Share this link with your network. When they sign up and subscribe, you get account credits!</p>
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 mt-2">
            <p className="text-sm text-text-secondary">Did someone invite you? Enter their code here to give them credit.</p>
