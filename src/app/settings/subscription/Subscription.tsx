...
import PricingPopup from "@/app/pricing/PricingPopup";

/**
 * Client component for Subscription page.
 * Displays subscription plan details, payment methods, and pricing options.
 * Handles interactive features: pricing popup modal.
 * Currently displays hardcoded subscription data.
 */
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out flex flex-col gap-6 w-full max-w-3xl">
        <div className="mb-2">
          ...
          <p className="text-text-secondary text-sm md:text-base">
            Manage your billing plan, payment methods, and invoices.
          </p>
        </div>
            ...
            <div className="bg-surface/50 backdrop-blur-md border border-border/60 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mt-2 shadow-sm">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-text-secondary">
                  Billed $19.99 monthly. Next charge on Nov 25, 2026.
                </p>
                <div className="flex items-center gap-3 mt-3">
                  <span className="flex items-center gap-1 text-xs text-text-main">
                    <CheckCircle2 className="w-3.5 h-3.5 text-primary" /> 5 Social Accounts
                  </span>
                  <span className="flex items-center gap-1 text-xs text-text-main">
                    <CheckCircle2 className="w-3.5 h-3.5 text-primary" /> Unlimited Posts
                  </span>
                </div>
              </div>
