        ...
        <div className="w-full max-w-sm md:min-w-sm md:max-w-lg mx-auto lg:mx-0 text-center lg:text-left flex flex-col justify-center h-full p-4 lg:pt-0">
          ...
          <Reveal delay={0.2}>
            <p className="text-lg sm:text-xl text-text-secondary leading-relaxed">
              ...
              or general feedback, we&apos;re here to help. Drop us a line and we&apos;ll respond as
              soon as possible.
            </p>
          </Reveal>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`input-base appearance-none cursor-pointer ${
                        isReasonError ? "input-error" : "input-default"
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    ...
                    {isOverLimit && <span className="inline-error">WORD LIMIT EXCEEDED</span>}
                  </label>
                  <textarea
                    id="contactMessage"
                    name="message"
                    ...
                    className={`input-base resize-none ${
                      isMessageError ? "input-error" : "input-default"
                    }`}
                  />
