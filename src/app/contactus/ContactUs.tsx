...
export default function ContactUs() {
    ...
    return (
        // Changed: Added 'mx-auto' to center the max-w-6xl container
        <div className="w-full max-w-6xl mx-auto animate-in fade-in duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20 items-start">

                {/* --- LEFT COLUMN: INFO --- */}
                {/* Changed: Added 'mx-auto lg:mx-0' to center block on mobile, left on desktop */}
                {/* Changed: Added 'text-center lg:text-left' to center text on mobile */}
                ...
                {/* --- RIGHT COLUMN: FORM --- */}
                {/* Changed: Added 'mx-auto lg:mx-0' to center the form card on mobile */}
