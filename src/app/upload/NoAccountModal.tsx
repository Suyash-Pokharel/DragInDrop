  ...
  return createPortal(
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        className={`bg-background w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden flex flex-col relative border border-border transition-all duration-300 ease-out transform p-6 ${
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center mt-4">
          ...
          <div className="flex w-full gap-3">
            <button
              onClick={doClose}
              className="flex-1 px-4 py-2 rounded-xl text-sm font-medium border border-border hover:bg-surface-highlight transition-colors text-text-main"
            >
              Later
            </button>
            <button
              onClick={handleConnect}
              className="flex-1 px-4 py-2 bg-primary hover:bg-secondary text-white rounded-xl text-sm font-medium transition-colors"
            >
              Connect Account
            </button>
          </div>
