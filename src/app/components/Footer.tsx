        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="col-span-1 lg:col-span-4 flex flex-col">
            ...
            <p className="text-text-secondary leading-relaxed max-w-sm">
              The simplest way to schedule, organize, and automate your video content across all your favorite social platforms from one unified dashboard.
            </p>
          </div>
          ...
          <div className="col-span-1 lg:col-span-2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 text-text-secondary font-medium">
              <Link href="/" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Home</Link>
              <Link href="/pricing" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Pricing</Link>
              <Link href="/contactus" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Contact Us</Link>
              <Link href="/login" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Login</Link>
              <Link href="/register" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Register</Link>
            </div>
          </div>
          ...
          <div className="col-span-1 lg:col-span-2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 text-text-secondary font-medium">
              <Link href="#" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Terms of Service</Link>
              <Link href="#" className="hover:text-primary transition-colors hover:translate-x-1 duration-300 w-fit">Privacy Policy</Link>
            </div>
          </div>
