...
const PROTECTED_ROUTES = ["/dashboard", "/admin", "/settings", "/calendar"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/admin/:path*", "/createpassword", "/settings", "/settings/:path*", "/calendar", "/calendar/:path*"],
};